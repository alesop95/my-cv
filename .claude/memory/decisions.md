...
## ADR-010 - I tre ruoli dell'archivio: Proton archivia e pubblica, attachments è la copia di lavoro

Data: 2026-09-04. Amenda ADR-009 sul solo ruolo di archivio; il resto di ADR-009 resta in vigore.

Contesto: ADR-009, deciso poche ore prima, assegnava a Google Drive il ruolo di archivio e a Proton quello di superficie di pubblicazione. Discutendo dove tenere la raccolta completa è emerso che stavamo trattando tre funzioni come se fossero una, ed è quella confusione ad avere prodotto quasi tutta la difficoltà di questi due giorni. La prima funzione è l'archivio, cioè dove sta la raccolta completa. La seconda è la pubblicazione, cioè cosa può aprire uno sconosciuto che clicca un link del CV. La terza è il backup, cioè una copia fuori sede.

Opzioni valutate. La proposta iniziale dell'utente era fare di `attachments/` la fonte di verità unica, cartella locale già ignorata da git per ADR-003 così da non mettere file pesanti su GitHub. Ha due difetti non rimediabili: una cartella locale non ha una URL, quindi non può servire la pubblicazione, perché nessuno al mondo può cliccarla; ed essendo ignorata da git nessuno ne conserva copia, quindi come fonte di verità unica un disco che muore porta via l'archivio intero, mentre oggi Drive svolge anche da copia fuori sede. Una seconda opzione teneva tre posti con tre ruoli espliciti, locale per lavorare, Proton per pubblicare e Drive solo come backup: coerente, ma mantiene una dipendenza da Google per un ruolo che Proton copre già.

Scelta: Proton Drive tiene la raccolta completa in cartelle private e genera link pubblici soltanto per il sottoinsieme che il CV e le pagine dei progetti citano, coprendo così archivio, pubblicazione e copia fuori sede con un solo servizio e nessun punto singolo di guasto. `attachments/` di questo repository resta la copia di lavoro locale, ignorata da git, comoda per LaTeX e per caricare su Proton. Google Drive esce dall'architettura.

Precisazione su "esce dall'architettura", perché l'espressione è ambigua e la lettura adottata è la più prudente. L'utente ha dichiarato esplicitamente, poche ore prima, di non volere cancellazioni da Google Drive, e ha poi scelto un assetto la cui descrizione diceva che Drive si ritira del tutto. Le due cose si conciliano in un solo modo: Drive smette di essere un ruolo dell'architettura, cioè nessun link vi punta e nessun processo ne dipende, ma nulla viene cancellato e resta come copia dormiente. Se l'intenzione era invece cancellare, va detto e questa ADR va emendata: non si deduce da un'opzione scelta ciò che una frase precedente aveva escluso.

Azione aperta che questa decisione comporta, e che ha un costo reale: la raccolta completa oggi su Drive va caricata nelle cartelle private di Proton, ed è più grande di `attachments/`, che pesa 8,4 MB su 29 file, perché include fra l'altro le cartelle di stampa 3D, argilla, lavoro creativo per casa e l'albero dei Bisogni Educativi Speciali. Il piano gratuito di Proton è 5 GB: prima di procedere conviene misurare quanto pesa davvero quella raccolta, perché è l'unico vincolo che potrebbe far cadere la scelta.

Conseguenza sul CV, che non cambia: ADR-009 resta valido nella parte che conta per il documento. Quando un link del CV punta a una raccolta e non a un documento, la domanda non è dove spostare la raccolta ma quale singolo file pubblicare, e se quel file non esiste il link deve puntare a una pagina descrittiva.

Emendamento del 2026-09-08, che restringe la scelta invece di ribaltarla. La misura che l'azione aperta chiedeva è stata eseguita il 2026-09-04 con l'SSD montato, e il suo esito nega la premessa nella forma in cui era scritta: la cartella sincronizzata con Google Drive pesa 6,2 GB su 6115 file e non entra nei 5 GB del piano gratuito, quindi Proton non può tenere la raccolta completa. La scelta regge invece nella forma stretta, ed è in questa che va letta da qui in avanti: Proton archivia e pubblica il perimetro del CV, che pesa 177 MB fra certificazioni, scienze dell'educazione e creatività, non l'intero disco. La frase "Google Drive esce dall'architettura" resta vera nel senso già precisato sopra, cioè che nessun link vi punta e nessun processo ne dipende, ed è stata raggiunta il 2026-09-07 quando `drive.google.com` è scesa a zero in tutto il perimetro; non è vera nel senso che Drive non contenga più nulla, perché nulla è stato cancellato e non deve esserlo. Il seguito operativo, cioè quali altre cartelle spostare e con quale vincolo sul watcher che le sorveglia, è la Fase 7 di `roadmap.md` e non un'altra decisione.

## ADR-011 - Materiale di studio in cartella aziendale: si anonimizza alla fonte, non si sposta

Data: 2026-09-08. Non amenda ADR-009 né ADR-010: risolve un caso che quelle due non coprivano.

Contesto: la Fase 7 vuole portare l'archivio di studio su Proton, `Ongoing studies` compresa, sia per avere un archivio solo invece di due da allineare sia perché quel materiale documenta competenze che fanno curriculum. La sua sottocartella `CYBERSECURITY, BC, governance` è però specchiata in bidirezionale con la OneDrive aziendale da `C:\Scripts\folder-sync-watcher` con risoluzione dei conflitti su `newest`, e conteneva riferimenti aziendali espliciti: nome dell'azienda, indirizzi email, indirizzi IP e nomi di persone. Portarla così com'era su un cloud personale avrebbe significato portarci informazione aziendale, che è la sola cosa che l'utente esclude.

Il punto di partenza, nella formulazione dell'utente, è che il problema si pone solo se c'è informazione aziendale: quel materiale è documentazione di studio della propria esperienza, utile anche in contesto aziendale ma non di proprietà dell'azienda, e il senso di averlo su Proton è avere sempre gli stessi file da leggere ovunque. La domanda diventa quindi come azzerare quel rischio, non se rinunciare allo spostamento.

Opzioni valutate. Rinunciare a spostare la cartella: scartata, perché è la parte più vicina alle Capability che il CV linka già, e lasciarla fuori svuotava entrambi gli obiettivi della fase. Tenere una copia personale anonimizzata accanto all'originale non anonimizzato: scartata su richiesta esplicita dell'utente, che non vuole doppie copie sbagliate, ed è una ragione solida perché due copie della stessa conoscenza con contenuto diverso sono una trappola per chi le legge sei mesi dopo. Spostare senza anonimizzare: mai in discussione, è il vincolo di partenza.

Scelta: si anonimizzano i documenti alla fonte, sostituendo gli originali nel sottoalbero specchiato con le versioni anonimizzate, e a quel punto la cartella si sposta su Proton come le altre. L'anonimizzazione non è quindi un'alternativa allo spostamento ma la sua precondizione: cade la premessa che rendeva quel materiale aziendale, e resta un archivio di studio unico, senza duplicati divergenti. Cosa si rimuove: nome dell'azienda, indirizzi email, indirizzi IP, nomi di persone aziendali o correlate all'azienda. Cosa non si rimuove: i nomi degli autori del materiale di studio, perché citare l'autore di una fonte è corretto e togliere quel nome peggiora il documento invece di proteggerlo.

Conseguenza dichiarata e accettata, che è la parte da non dimenticare: la cartella è specchiata con politica `newest`, quindi al riavvio del watcher le versioni anonimizzate sovrascriveranno anche le copie sulla OneDrive aziendale. Non è un effetto collaterale imprevisto ma il modo in cui questa scelta si propaga, e l'utente lo ha accettato dopo esserne stato avvisato. Ne segue l'unico presidio obbligatorio: gli originali si conservano in una cartella di sicurezza prima di essere sovrascritti, perché con il watcher fermo non esiste una seconda copia viva da cui recuperare.

Precedente che questa ADR stabilisce, ed è la ragione per cui è una decisione e non una nota operativa: quando un contenuto è conoscenza dell'utente ma vive in un contenitore aziendale, la domanda non è se rinunciarvi ma che cosa esattamente lo rende aziendale. Se quel che lo rende aziendale è rimovibile senza danneggiare il contenuto, si rimuove e poi il contenuto si tratta come proprio a tutti gli effetti, spostamento su cloud personale incluso; se non lo è, il contenuto resta dove sta e si racconta senza pubblicarlo. Il criterio è quindi permissivo per costruzione, non restrittivo, e va letto in quel senso: la restrizione riguarda l'informazione aziendale, non il contenitore in cui l'informazione si trovava.
...
Contesto: la ricognizione del 2026-09-10, nata da una domanda dell'utente e non da un controllo pianificato, ha stabilito che fra `J:\googleDrive_sync\Portfolio and ongoing studies` e Proton le cartelle duplicate erano sette su dieci, 2358 file per circa 1,70 GB, e non tre. Quattro di esse erano invisibili perché su Proton portano un nome tradotto: `Certificazioni, partecipazioni, corsi e attestati` sta là come `Certifications`, `Educational Sciences, Psychology, Pedagogy, Didactics and School Studies` come `Education studies`, `Creativity` come `Portfolio` e `Progetti (ricerca)` come `Research projects`. Le date di creazione dicono che nascono tutte il 2026-09-07 alle 15:23, cioè per caricamento di cartelle intere durante la riorganizzazione di Proton, mentre il memo di ADR-009 del 2026-09-04 prescriveva di caricare il solo file linkato dal CV.

Il punto che questa decisione scioglie era già previsto per iscritto. ADR-009 dice che se l'intenzione era invece cancellare va detto e quella ADR va emendata, perché non si deduce da un'opzione scelta ciò che una frase precedente aveva escluso. L'utente lo ha detto il 2026-09-10, ponendo come sola condizione la prova che nulla andasse perso.

Opzioni valutate. Lasciare tutto com'era, con Drive copia dormiente: scartata perché l'utente vuole una fonte unica di verità, e due copie della stessa cosa in due cloud sono esattamente la trappola che ADR-011 aveva già rifiutato per il materiale anonimizzato. Spostare le sette cartelle in una cartella di sosta sull'SSD fuori dal perimetro di sync, sul modello di `J:\_originali-prima-anonimizzazione\`: proposta come raccomandazione perché conserva una rete di sicurezza a costo zero, e scartata dall'utente, che ha chiesto la cancellazione una volta accertata la prova. Cancellare: scelta.

Scelta: le sette cartelle duplicate sono state rimosse da `J:\googleDrive_sync` il 2026-09-10, e Proton resta la fonte unica per il loro contenuto. Restano su `J:` le tre non duplicate, cioè `Miscellaneous, Utilities, Tools`, `Interesting books` e `Ongoing studies`, quest'ultima perché il suo spostamento dipende dal watcher.

Condizione che ha reso possibile la scelta, ed è la parte da non dimenticare: la prova per SHA256 file per file su tutte e sette le cartelle, ottenuta il 2026-09-09 per le tre del microstep 1 e riconfermata il 2026-09-10, e ottenuta il 2026-09-10 per le quattro scoperte quel giorno. Zero file mancanti, zero diversi, zero in più. Senza quella prova la scelta non sarebbe stata proposta, perché il confronto per nome e dimensione identifica ma non autorizza.

Conseguenze accettate, dichiarate prima di procedere. La copia resta una sola, nel cloud di Proton, perché il lato Proton è tenuto solo online e su questa macchina non esiste copia locale: si guadagna una fonte unica e si perde la ridondanza, ed è una scelta di ridondanza e non di ordine. La cancellazione si propaga a Google Drive al primo avvio del suo client, che al 2026-09-10 è fermo, quindi fino a quel momento il cloud di Google conserva ancora i file e la finestra di ripensamento resta aperta. E ADR-009 va letta d'ora in avanti così: Drive non è più nemmeno una copia dormiente per il contenuto duplicato, mentre resta intatto tutto ciò che su Proton non c'è.

Precedente che questa ADR stabilisce: una prescrizione scritta in una scheda non è una verifica. Il memo di ADR-009 diceva di caricare il solo file linkato, l'esecuzione ha caricato cartelle intere tre giorni dopo averlo scritto, la documentazione ha continuato a descrivere l'intenzione, e a scoprire lo scarto è stata una domanda dell'utente. Quando una scheda afferma che un sistema esterno si trova in un certo stato, quello stato va misurato periodicamente, perché la scheda registra ciò che si è deciso e non ciò che è successo.

## ADR-013 - La lista di che cosa resta da fare si misura, non si scrive

Data: 2026-09-22. Non emenda alcuna ADR precedente: aggiunge un terzo artefatto generato accanto a quelli di ADR-008 e del grafo di architettura.

Contesto: la domanda dell'utente era avere una roadmap pulita e puntuale di che cosa fare in ogni punto del progetto e su ogni link. La risposta non esisteva in un posto solo. `roadmap.md` porta la cronaca narrativa delle sette fasi, `index.md` il punto di ripresa, la mappa dello stato una tabella parziale, `decisions.md` il perché: quattro documenti scritti a mano, quindi quattro documenti che invecchiano insieme. Nel raccoglierli è emersa la prova che il problema non era teorico: il difetto della virgoletta dritta di "Hold Me Tight" era elencato fra i difetti noti aperti in due file da luglio, mentre il testo che lo conteneva era uscito da `main.tex` il 2026-07-15 e nelle occorrenze migrate in `projects` le virgolette sono simmetriche. Nessuno aveva scritto una cosa falsa: la lista non aveva alcun modo di accorgersi che il mondo fosse cambiato sotto di essa.

Opzioni valutate. Scrivere la lista a mano in una scheda nuova: scartata, perché sarebbe stata falsa entro la settimana per la stessa ragione delle altre quattro, e avrebbe aggiunto una quinta fonte di verità invece di toglierne quattro. Riscrivere la mappa dello stato di `roadmap.md` rendendola esaustiva: scartata perché cambia la dimensione del problema e non la sua natura, dato che resterebbe scritta a mano. Generarla da git e dai controlli senza alcun file dati: scartata perché nessuna misura può dedurre che una traduzione manca o che una decisione è sospesa, e una lista che contenesse i soli difetti meccanici sarebbe la parte meno importante spacciata per il tutto.

Scelta: separare il giudizio dalla misura, che è lo stesso principio di ADR-008 applicato a un oggetto diverso. Il giudizio umano, cioè quale lavoro resta, dove vive, perché e a che costo, sta in `tools/roadmap-items.yml`, versionato e modificato solo a mano. Lo stato, cioè il commit di riferimento, la distanza delle schede da HEAD, l'esito dei controlli documentali e la raggiungibilità dei link, non sta in alcun file e viene misurato da `tools/roadmap.py` a ogni invocazione. L'uscita vive in `build/`, ignorata da git, perché è un derivato come i PDF e come i log.

Due scelte di progetto dentro la scelta, entrambe deliberate. L'ordinamento è per costo crescente e non per importanza, su quattro livelli che vanno dai minuti al lavoro che non si chiude dentro questo repository: una lista ordinata per gravità si legge e non si usa, perché la prima voce richiede una settimana. E una voce può dichiarare una sonda, cioè come la macchina stabilisce da sola se il difetto c'è ancora, per presenza o assenza di una stringa in un file oppure per esito di un controllo: le voci che la misura smentisce finiscono in una sezione a parte e non spariscono, perché toglierle dal file dati è una decisione e resta di chi verifica.

Limite dichiarato, strutturale e non risolvibile con più codice: una sonda copre il solo lavoro che ha una traccia testuale, e la maggior parte del lavoro non ce l'ha. La revisione madrelingua dello spagnolo, una pagina da riscrivere, una decisione sospesa non lasciano una stringa che sparisce. Le sonde si mettono dove il difetto è meccanico, che è esattamente dove una lista tenuta a mano resta sbagliata più a lungo, perché un difetto meccanico è anche quello che nessuno rilegge.
